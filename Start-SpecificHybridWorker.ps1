function Start-SpecificHybridWorker {
    ...
    You MUST use New-ManagedIdentityAccessToken.ps1 for this function. 
...
#>
        ...
        try {
            ...
            if ($env:COMPUTERNAME -eq 'CLIENT') {
                ...
                if ($null -eq $($PSBoundParameters.HybridWorker)) {
                    ...
                    Write-Verbose "Start-SpecificHybridWorker: begin: First Hybrid Worker in list: $($PSBoundParameters.HybridWorker)"
                }
    ...
    process {
        ...
        elseif ($env:COMPUTERNAME -ne $PSBoundParameters.HybridWorker) {
            ...
            Write-Verbose "Start-SpecificHybridWorker: process: Starting sleep: $startSleep"
